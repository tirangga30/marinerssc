...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-8 sm:space-y-16 pb-12">
      ...
      {/* HERO SECTION - LOWER ALIGNED TEXT & BUTTONS */}
      <section className="relative pt-20 sm:pt-64 pb-8 sm:pb-16 min-h-[45vh] sm:min-h-[85vh] flex items-end justify-center overflow-hidden border-b border-blue-500/20 px-2 sm:px-3">
        <div 
