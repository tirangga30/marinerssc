...
export default async function HomePage() {
  ...
  return (
    <div className="space-y-8 sm:space-y-16 pb-12">
      ...
      {/* HERO SECTION - 1:1 ASPECT RATIO ON MOBILE & VERY BOTTOM ALIGNED TEXT */}
      <section className="relative aspect-square sm:aspect-none sm:min-h-[85vh] w-full flex items-end justify-center overflow-hidden border-b border-blue-500/20 px-2 sm:px-3 pb-3 sm:pb-16 pt-24 sm:pt-64">
        <div 
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#060b14] via-[#060b14]/65 to-[#060b14]/15" />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-2 text-center space-y-2 sm:space-y-5 pb-1 sm:pb-4">
