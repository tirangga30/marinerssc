  ...
  return (
    <div className="space-y-16 pb-12">
      ...
      <section className="relative min-h-[85vh] flex items-center justify-center overflow-hidden border-b border-blue-500/20">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-blue-500/20 rounded-full blur-[130px] pointer-events-none" />

        <div className="relative z-10 max-w-5xl mx-auto px-4 text-center space-y-6 pt-12">
          
          {/* Badge Top */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass-panel-blue text-sky-300 text-xs font-extrabold uppercase tracking-widest animate-pulse">
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 pt-4">
            <Link
              href="/players"
              className="flex items-center gap-2 px-6 py-3.5 rounded-xl font-extrabold uppercase white-blue-btn text-sm"
            >
              Lihat Skuad Tim
            ...
            <Link
              href="/matches"
              className="flex items-center gap-2 px-6 py-3.5 rounded-xl font-bold uppercase text-white glass-panel border border-slate-700 hover:border-sky-400 hover:text-sky-300 transition-all text-sm"
            >
              Jadwal Pertandingan
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-20 relative z-20">
        <div className="glass-panel p-6 sm:p-8 rounded-2xl border border-sky-400/30 shadow-2xl shadow-slate-950">
          ...
          <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-6">
            ...
            <span className="text-xs font-bold px-3 py-1 rounded-full bg-blue-950/80 text-sky-300 border border-sky-400/30">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-center">
              ...
              <div className="space-y-2">
                {nextMatch.status === 'finished' ? (
                  <div className="text-4xl sm:text-5xl font-black font-mono blue-gradient-text tracking-widest">
                    {nextMatch.homeScore} : {nextMatch.awayScore}
                  </div>
                ) : (
                  <div className="inline-block px-5 py-2 rounded-xl bg-blue-600/30 text-sky-300 font-black text-2xl border border-sky-400/50">
                    VS
                  </div>
                )}
                ...
                <p className="text-[11px] text-slate-400 truncate max-w-xs mx-auto">{nextMatch.venue}</p>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-center md:justify-start gap-4">
                ...
                <div className="text-center md:text-left">
                  <h4 className="text-xl font-black text-white uppercase">{nextMatch.opponentName}</h4>
          ...
          <div className="mt-6 pt-4 border-t border-slate-800 flex justify-center">
            <Link
              ...
              className="text-xs font-bold uppercase tracking-wider text-sky-400 hover:text-white flex items-center gap-1.5 transition-colors"
            >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-slate-800 pb-4">
          ...
          <Link
            href="/players"
            className="text-xs font-bold uppercase tracking-wider text-sky-400 hover:text-white flex items-center gap-1"
          >
          ...
          {featuredPlayers.map((player: any) => (
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden bg-slate-900">
                ...
                {/* Number Badge */}
                <div className="absolute top-4 right-4 w-10 h-10 rounded-xl blue-gradient-bg text-white font-black text-lg flex items-center justify-center shadow-lg border border-white/20">
                  #{player.number}
                </div>

                {player.isCaptain && (
                  <div className="absolute top-4 left-4 px-2.5 py-1 rounded-md bg-white text-blue-950 font-black text-[10px] uppercase tracking-wider shadow">
                    KAPTEN
                  </div>
                )}
              </div>
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-300 line-clamp-2 mt-1">{player.bio}</p>
                </div>
        ...
        <div className="glass-panel p-8 rounded-2xl border border-sky-400/20 bg-gradient-to-r from-blue-950/60 via-[#060b14] to-blue-950/60">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
              <span className="text-3xl font-black font-mono blue-gradient-text block">{winRate}%</span>
              <span className="text-xs font-semibold uppercase text-slate-400 mt-1 block">Win Rate</span>
            </div>
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
              <span className="text-3xl font-black font-mono text-white block">{totalGoals}</span>
            ...
            <div className="p-4 rounded-xl bg-slate-900/80 border border-slate-800">
              <span className="text-3xl font-black font-mono text-sky-400 block">#1</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            <span className="text-xs font-bold uppercase tracking-widest text-sky-400">Kabar Terbaru</span>
            <h2 className="text-2xl sm:text-3xl font-black uppercase text-white mt-1">
              Berita Seputar Klub
            </h2>
          </div>
          ...
          {articles.map((article: any) => (
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                ...
                <span className="text-xs font-bold text-sky-400 flex items-center gap-1 pt-2">
